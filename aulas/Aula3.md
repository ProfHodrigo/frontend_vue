# Aula 3 — Comunicação com API (Axios)# Aula 3 — Comunicação com API (Axios)# Aula 3 — Comunicação com API (Axios)## Aula 3 — Comunicação com API (Axios)## Aula 3 — Comunicação com API (Integrando com Flask)
